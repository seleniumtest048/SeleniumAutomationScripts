...
/*
    ...
    public static void startSuite(String suiteName){
        ...
        out.write("<td width=10%  align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>BrowserName</b></td>\n");
		...
		try {
		   ...
		   if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")){
			...
			out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> Detailed Report :</h4>");
		 	 ...
		 	 if(description!=null){
		 		 for(int i=0;i<description.size();i++){
		 			 out.write("<tr> ");
		 			 if (i==0 || teststatus.get(i).equals("desc")) {
		 				out.write("<td align=left width=10%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b></b></td>");
		 				out.write("<td align=left bgcolor=#d3d3d3 width=50%><FONT COLOR=#153E7E FACE=Arial SIZE=3><b>"+description.get(i)+"</b></td>");
		 				out.write("<td width=10% align= left  bgcolor=#d3d3d3><FONT COLOR=#153E7E FACE=Arial SIZE=2><b></b></td>\n");
					}else{
						out.write("<td align=left width=10%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b>TS"+(i+1)+"</b></td>");
						...
						if(teststatus.get(i).startsWith("Pass")){
			 			    ...
			 			    if(screenShotPath.get(i) != null){
			 			    	System.out.println("Navigating to screen shot======="+screenShotPath.get(i));
			...
			// out.newLine();
		     ...
		     out.write("<td width=10% align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>"+browser+"</b></td>\n");
		     if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
		    	 out.write("<td width=40% align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>"+testCaseName+"</b></td>\n");
		     else
		    	 out.write("<td width=40% align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+".html>"+testCaseName+"</a></b></td>\n");
	...
	public static void addKeyword(String desc,String key,String stat,String path){
		...
		keyword.add(key);
		teststatus.add(stat);
		System.out.println("Adding screen shot path======="+path);
